...
- random_prime(b): Return a random prime number of length b bits. This operation may use probabilistic primality tests.
- is_prime(p): Return true if the input integer p is prime, and false otherwise. This operation may use probabilistic primality tests.
